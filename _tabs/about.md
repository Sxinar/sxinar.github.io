...
# Analiz (Gizliliğinizi önemseyen) 

> Bu web sitesi UMAMI aracılığıyla tamamen anonim ve gizliliğinizi önemseyen bir şekilde Blog yazılarımı ve istatistikleri analiz etmemi sağlıyor. Ublock Origin bu analizi zararlı görüp engellemiyor eğer isterseniz filtrenizden reddedebilirsiniz.
...
*   Kullanılan Canlı Proxy Altyapısı: [artados.vercel.app](https://artstelve-proxy.vercel.app)
*   Porsuk: https://porsuk.vercel.app
